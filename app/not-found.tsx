...
// ** Demo Imports
import FooterIllustrations from 'src/views/pages/misc/FooterIllustrations'; // Ensure this is client compatible

// ** Styled Components (copied from original 404.tsx)
...
export default function NotFound() { // Renamed from Error404
  return (
